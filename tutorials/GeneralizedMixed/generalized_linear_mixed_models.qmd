...
We can see from the ICC (or conditional R^2^) that `r round(icc(m0)$ICC_adjusted, 3) * 100`% of the variance in dropout rate is explained by the grouping variable, `school_id`.
