...
date: "Advanced Data Analysis (EDUC 8825)"
engine: knitr
knitr: 
  opts_chunk: 
    warning: false
...
```{r importdata, warning=FALSE, cache=TRUE}
...
The ICC for this model suggests that schools are highly segregated by reading ability. That is, variation by classroom accounts for `r scales::percent(performance(m_read_1_0)$ICC)` of the variance in reading~1~.
...
::: question
**Question 1**: Is `school_ses` a significant predictor?
:::

::: question
**Question 2**: Comparing Models 1 and 2, by how much did `school_ses` reduce L2 variability?
:::

::: hint
**Hint**: Use the `variance_reduction` function defined earlier:
...
Note the double bar (`||`). It means uncorrelated slopes.
...
::: question
**Question 3**: Does Model 3 fit better than Model 2?
:::
...
::: hint
Hint: If X is L1 and A is L2, X has random slopes correlated with random intercepts if
...
::: question
**Question 4**: Does Model 4 fit better than Model 3?
:::
...
::: hint
**Hint**: If X is L1 and A is L2, the cross-level interaction is specified like so:

`Y ~ 1 + X * A + (1 + X | cluster_id )`
:::

::: question
**Question 5**: Does Model 5 fit better than Model 4?
:::

::: question
**Question 6**: Compared to Model 0, by how much is level-2 variance reduced by model 5?
:::
...
::: question
**Question 7**: Compared to Model 0, by how much is level-1 variance reduced by model 5?
:::

::: question
**Question 8**: What is your overall interpretation of these data?
:::

Some plots that might aid your interpretation:
