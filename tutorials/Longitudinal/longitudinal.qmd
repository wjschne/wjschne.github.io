...
date: "2025-03-11"
description: Multilevel models about how and why variables change over time
engine: knitr
knitr: 
  opts_chunk: 
    warning: false
...
```{r fig-plottime}
#| fig-cap: Linear Effects of Time on Reading Comprehension
