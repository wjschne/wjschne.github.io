...
Thus, `gender` explains `r round(100 * r2_semipartial(m2)$r2_semipartial[2] ^ 2, 0)`% variance beyond `avgphgt`. Likewise, `avgphgt` explains `r round(100 * r2_semipartial(m2)$r2_semipartial[1] ^ 2, 0)`% variance beyond `gender`.
