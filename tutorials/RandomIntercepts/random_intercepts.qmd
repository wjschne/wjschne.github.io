...
description: Regression in which each group has its own intercept
date: 2025-01-27
engine: knitr
knitr: 
  opts_chunk: 
...
![A point with high leverage and a large residual can cause large changes in the regession coefficients.](../Regression/leverage.gif){#fig-leverageplot}
...
With a *t* value of `r round(broom.mixed::tidy(m_1)$statistic[2], 2)`, the effect of `treatment` is surely significant. 
