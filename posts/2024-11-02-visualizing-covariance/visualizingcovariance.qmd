...
To figure it out, I create a little web app that allows the user to change the standard deviations of variables *x* and *y*, as well as the correlation between the two variables.
