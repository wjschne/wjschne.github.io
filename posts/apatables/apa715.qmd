...
Getting the output of `apa_parameters` and `apa_compare_performance` into the same table requires a rather complex process. I'd like to automate some of these steps. 
