...
3. Create a with [flextable](https://ardata-fr.github.io/flextable-book/).
4. Eliminate tedious formatting with apa7 functions (e.g,. `apa_flextable` and/or `apa_style`).
...
However, @tbl-71a requires additional formatting to become publication-worthy. The `apa_flextable` function performs several layers of transformations before and after applying `flextable`, most of which can be turned off selectively.
