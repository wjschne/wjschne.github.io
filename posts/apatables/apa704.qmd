...
![Screenshot of the *APA Manual*'s Table 7.4](table74.png){#fig-74 fig-align="left" width="100%"}

APA Manual Table 7.4 in @fig-74 is not entirely visible, so I have reproduced the visible rows only. This table is straightforward to make. I used [`flextable::merge_v`](https://davidgohel.github.io/flextable/reference/merge_v.html) to remove redundant text in the Study column.
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-end">
    ...
    <li class="page-item"><a class="page-link" href="apa703.html">Previous</a></li>
    <li class="page-item"><a class="page-link" href="apa705.html">Next</a></li>
