...
The `column_formats` function creates a modifiable copy of the default column formatters. I set the rounding accuracy of column `p` to .001, and I set the header of the `F` column to `*F* ratio`
