...
Here is code for the annotated equation. It is saved in `annotatedequationsimple.tex`.
...
And we are ready to plot. This plot shows the probability that an observed score will have a probability less than a specific threshold, given a reliability coefficient.
