...
categories: 
  - ggplot2
description: "Placing stacked bar chart labels on a smooth path makes them easier to compare."
tags:
  - ggplot2
  - R
---
...
library(tidyverse)
set.seed(10)
knitr::opts_chunk$set(dev = "ragg_png", fig.height = 8)
```
         ...
         d %>%
           ...
           guides(
             fill = guide_legend(
               ...
               label.position = "top",
               # Put text atop keys
               keyheight = unit(18, "mm"),
               # Size of legend rectangles
               keywidth = unit(20.7, "mm")
             )
           ) 
